...
<div class="container">
    <div class="row">
        <div class="col-md-6 ">
            <img class="rounded mx-auto d-block" src="{{('image/register.png')}}" alt="">
        </div>
        <div class="col-md-6">
                ...
                <div class="card-body border-success">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control border-success @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
