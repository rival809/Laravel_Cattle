        ...
        <div class="col-md-12 mt-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item " aria-current="page"><a href="{{ url('berita') }}">Berita</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Berita{{$beritas->id}}</li>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-12 mb-3 ">
                    <h1 class="Produk text-center">{{($beritas->judul_berita)}}</h1>
                </div>

                <div class="card border-success mb-3 ">
                    <img src="{{ url('image')}}/{{($beritas->gambar)}}" class="card-img-top mt-2" style="max-width: 440px;" alt="...">
                    <div class="card-body">
